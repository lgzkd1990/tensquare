        ...
        <div class="sui-navbar">
          <div class="navbar-inner">
            ...
            <form class="sui-form sui-form pull-left">
              ...
              <span class="btn-search fa fa-search" />
            </form>
            <div class="sui-nav pull-right info">
              ...
              <li class="hover">
                ...
                <ul class="hoverinfo">
                  <li><i class="fa fa-share-alt" aria-hidden="true" /> <a href="~/assets/headline-submit.html">去分享</a></li>
                  <li><i class="fa fa-question-circle" aria-hidden="true" /> <a href="~/assets/qa-submit.html" target="_blank">提问题</a></li>
                  <li><i class="fa fa-comments" aria-hidden="true" /><a href="~/assets/spit-submit.html" target="_blank">去吐槽</a></li>
                  <li><i class="fa fa-heartbeat" aria-hidden="true" /> <a href="~/assets/makeFriends-submit.html" target="_blank">发约会</a></li>
                </ul>
              </li>
      ...
      <div class="footer">
        <div class="wrapper">
          <div class="footer-bottom">
            ...
            <p class="Copyright">
              Copyright &copy; 2017 传智问答社区 当前版本 0.0.1
            </p>
          </div>
        </div>
      </div>
