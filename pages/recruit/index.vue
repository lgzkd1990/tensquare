          ...
          <ul class="yui3-g job-list" style="display:block;">
            <li v-for="(item,index) in recommendList" :key="index" class="yui3-u-1-2 job-item">
              <p>
                ...
                </span><span class="city"><i class="fa fa-map-marker" /> 北京</span>
              </p> <p class="need">
                <span class="money">{{ item.salary }}</span>/{{ item.condition }}/{{ item.education }}/{{ item.type }}
              </p> <p><span class="company">百度 &middot; 6天前</span></p>
            </li>
          </ul>
        </div>
      ...
      <div class="hot-company">
        ...
        <div class="company">
          ...
          <ul class="yui3-g company" style="display:block;">
            <li v-for="(item,index) in hostList" :key="index" class="yui3-u-1-3 company-item">
