      ...
      <div class="fl left-list">
        <div class="tc-data-list">
          <div class="tc-list">
            ...
            <div id="remarkModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  ...
                  <div class="modal-body">
                    ...
                    <div class="form">
                      <textarea class="form-control" rows="5" placeholder="匿名评论" />
                      <div class="remark">
                        <button class="sui-btn btn-info">
                          发表
                        </button>
                      </div>
                    </div>
